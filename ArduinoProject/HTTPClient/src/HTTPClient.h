...
public:
  ...
  /*
   * Since both begin() functions take a reference to client as a parameter, you
   * need to ensure the client object lives the entire time of the HTTPClient
   */
  ...
  void setRedirectLimit(
      uint16_t limit); // max redirects to follow for a single request
